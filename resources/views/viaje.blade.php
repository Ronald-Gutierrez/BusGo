...
@section('content')
    ...
    <div class="bus_box">
        <div class="buses">
            ...
            <li class="asiento_marco"><div class="asiento_circulo disponible">
                <sup>S/</sup>15
            </div>
            </li>
